...
# Canonical matcher — extracted verbatim to tools/refmatch.py (single source
# of matching truth; see SPEC §2.1). tools/ is on sys.path via root conftest.py.
from refmatch import load, resolve, wht_rate_bps
...
# ---------------------------------------------------------------- T4: legacy CIT
CIT_LEGACY = load("rp-cit-legacy", "1.0.0")  # pinned: T4 asserts 1.0.0 effective window
